...
public class CsvTableFactory extends AbstractTableFactory<CsvReportPage> {
    ...
    @Override
    public <T extends Enum<T> & TableHeaderColumn> Table create(ReportPage reportPage, String tableName, TableCellRange tableRange, Class<T> headerDescription, int headersRowCount) {
